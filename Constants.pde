...
String[] gestures = {"lefthandlock.png", "righthandlock.png", "bothhandlock.png", "lefthandpinch.png", "righthandpinch.png", "bothhandpinch.png", "bothhandcover.png", "lefthandfist.png", "righthandfist.png", "bothhandfist.png", "upperlefthandlock.png", "upperrighthandlock.png", "upperbothhandlock.png", "birdhand.png"};
...
String[] equations={"a+b=c", "(3*4)", "[7-2]", "e=mc2", "i=10;", "std::", "5%2=1", "4!=24", "#undef", "(i<5)", "cin>>", "()?:"};

// balanced latin square for 5 variables (word, click, equation, shortcut, gesture)
//String[][] taskOrders = {
//                         {"word", "click", "gesture", "equation", "shortcut"}, 
//                         {"click", "equation", "word", "shortcut", "gesture"}, 
//                         {"equation", "shortcut", "click", "gesture", "word"}, 
//                         {"shortcut", "gesture", "equation", "word", "click"}, 
//                         {"gesture", "word", "shortcut", "click", "equation"}, 
//                         {"shortcut", "equation", "gesture", "click", "word"}, 
//                         {"gesture", "shortcut", "word", "equation", "click"}, 
//                         {"word", "gesture", "click", "shortcut", "equation"}, 
//                         {"click", "word", "equation", "gesture", "shortcut"}, 
//                         {"equation", "click", "shortcut", "word", "gesture"}
//                         };

//String[][] taskOrders =  {  
//                        {"word","word","gesture","click","shortcut","word","equation"},
//                        {"word","click","word","word","gesture","equation","shortcut"},
//                        {"click","word","word","equation","word","shortcut","gesture"},
//                        {"word","equation","click","shortcut","word","gesture","word"},
//                        {"equation","shortcut","word","gesture","click","word","word"},
//                        {"shortcut","gesture","equation","word","word","word","click"},
//                        {"gesture","word","shortcut","word","equation","click","word"},
//                        {"equation","word","shortcut","click","gesture","word","word"},
//                        {"shortcut","equation","gesture","word","word","click","word"},
//                        {"gesture","shortcut","word","equation","word","word","click"},
//                        {"word","gesture","word","shortcut","click","equation","word"},
//                        {"word","word","click","gesture","word","shortcut","equation"},
//                        {"click","word","word","word","equation","gesture","shortcut"},
//                        {"word","click","equation","word","shortcut","word","gesture"}};

String[][][] practiceOrder={
                            {
                              //{"word","gesture","click"},
                              //{"gesture","shortcut","word"},
                              //{"gesture","word","shortcut"},
                              //{"click","gesture","equation"},
                              //{"gesture","click","shortcut"},
                              //{"gesture","click","word"},
                              //{"shortcut","gesture","equation"},
                              //{"word","gesture","click"},
                              //{"shortcut","gesture","equation"},
                              //{"gesture","click","word"},
                              //{"gesture","shortcut","equation"},
                              //{"word","click","gesture"},
                              //{"shortcut","gesture","equation"},
                              {"gesture","click","word"}
                            }
...
String[][][] experimentOrder= {
                                {
                                  //{"word", "equation", "shortcut", "equation", "gesture"}, 
                                  //{"click", "word", "gesture", "word", "shortcut"}, 
                                  //{"word", "shortcut", "equation", "gesture", "click"}, 
                                  //{"word", "word", "gesture", "word", "shortcut"}, 
                                  //{"equation", "shortcut", "click", "word", "gesture"}, 
                                  //{"equation", "shortcut", "click", "equation", "gesture"}, 
                                  //{"word", "gesture", "word", "equation", "shortcut"}, 
                                  //{"word", "word", "shortcut", "click", "gesture"}, 
                                  //{"equation", "gesture", "word", "click", "shortcut"}, 
                                  //{"equation", "equation", "shortcut", "equation", "gesture"}, 
                                  //{"click", "click", "gesture", "equation", "shortcut"}, 
                                  //{"word", "equation", "shortcut", "equation", "gesture"}, 
                                  //{"click", "equation", "gesture", "equation", "shortcut"}, 
                                  {"click", "shortcut", "click", "equation", "gesture"}
                                }, 
                                //{
                                //  {"click", "word", "shortcut", "click", "gesture"}, 
                                //  {"click", "gesture", "click", "word", "shortcut"}, 
                                //  {"word", "gesture", "word", "word", "shortcut"}, 
                                //  {"equation", "shortcut", "word", "word", "gesture"}, 
                                //  {"equation", "gesture", "click", "equation", "shortcut"}, 
                                //  {"click", "word", "gesture", "click", "shortcut"}, 
                                //  {"equation", "gesture", "equation", "shortcut", "equation"}, 
                                //  {"equation", "word", "gesture", "equation", "shortcut"}, 
                                //  {"click", "gesture", "equation", "word", "shortcut"}, 
                                //  {"equation", "shortcut", "word", "gesture", "word"}, 
                                //  {"click", "shortcut", "click", "gesture", "click"}, 
                                //  {"click", "equation", "shortcut", "word", "gesture"}, 
                                //  {"click", "equation", "gesture", "word", "shortcut"}, 
                                //  {"word", "shortcut", "equation", "click", "gesture"}
                                //}, 
                                //{
                                //  {"word", "shortcut", "equation", "gesture", "equation"}, 
                                //  {"equation", "word", "shortcut", "word", "gesture"}, 
                                //  {"word", "gesture", "word", "shortcut", "equation"}, 
                                //  {"equation", "gesture", "equation", "word", "shortcut"}, 
                                //  {"word", "gesture", "click", "shortcut", "word"}, 
                                //  {"click", "shortcut", "equation", "equation", "gesture"}, 
                                //  {"click", "shortcut", "equation", "click", "gesture"}, 
                                //  {"word", "gesture", "equation", "click", "shortcut"}, 
                                //  {"click", "gesture", "equation", "click", "shortcut"}, 
                                //  {"click", "gesture", "click", "shortcut", "equation"}, 
                                //  {"word", "click", "shortcut", "click", "gesture"}, 
                                //  {"click", "gesture", "click", "shortcut", "word"}, 
                                //  {"word", "click", "shortcut", "click", "gesture"}, 
                                //  {"word", "click", "gesture", "click", "shortcut"}
                                //}
                              };
