...
CaptureFrame thread;
Boolean verbose = true;//false;// log video frame events
...
int taskSpeed = 6;
int postureTimer = 6000;

String startTime, experimentStartTime, experimentEndTime, blockStartTime, blockEndTime, setStartTime, setEndTime, targetStartTime, targetEndTime;

enum WiggleMode { INC, DEC}
HashMap<String,PImage> iconSet = new HashMap<String,PImage>();
